<?php
   ...
   $connect = new mysqli("localhost","root","lxy369874521" );
	...
	$sq3 = "CREATE TABLE DBTEST1.Stocks_history (StockID INT(11) NOT NULL  AUTO_INCREMENT, PRIMARY KEY(StockID), Symbol VARCHAR(30) ,Date date NOT NULL, Open DECIMAL(7,2) NOT NULL, High DECIMAL(7,2) NOT NULL, Low DECIMAL(7,2) NOT NULL, Close DECIMAL(7,2) NOT NULL, Volume INT(10) NOT NULL)";
